      ...
      <div className="home-landing">
        <div className="top bg-white">
          <Row>
            ...
            <Col span={14}>
              <p className="text">
                Together deliver a safe and globally competitive copper business
            ...
            <Col span={12}>
              <div className="desc">
                <p>
                  ...
                  national companies to participate in bidding process via SQMS
                  and contributes further development of  national companies.
                </p>
                <p>
