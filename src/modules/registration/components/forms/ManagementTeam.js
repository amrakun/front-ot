      ...
      <Form onSubmit={this.handleSubmit}>
        <Row>
          <Col xs={24} sm={12}>
            ...
            {this.renderMember('managing_director', true)}
            <label>16. Executive officer</label>
            {this.renderMember('executive_officer', true)}
            <label>17. Sales director</label>
            {this.renderMember('sales_director', true)}
            <label>18. Financial director</label>
            {this.renderMember('financial_director', true)}
          </Col>
          <Col xs={24} sm={12}>
            <label>19. Other management team member</label>
            {this.renderMember('team_member_1', true)}
            <label>Other management team member 2</label>
            {this.renderMember('team_member_2', false)}
            <label>Other management team member 3</label>
            {this.renderMember('team_member_3', false)}
          </Col>
        </Row>
